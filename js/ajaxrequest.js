...
// A ECRIRE
        ...
        if (requestThis.transport.readyState == 4 || requestThis.transport.readyState == "complete") {
            ...
            if (requestThis.transport.status == 200) {
                ...
                requestThis.onError(requestThis.transport.status, "Code erreur " + requestThis.transport.statusText + " après réception de ");
...
// A ECRIRE
        // Open transport
        this.transport.open(this.method, this.url + "?" + parametersString, true);
        // Send request
        this.transport.send();
    }
    else {
