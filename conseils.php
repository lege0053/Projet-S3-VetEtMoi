...
<div style="display: flex; flex-direction: column; margin: 30px; row-gap: 30px;">
    <div class="d-flex justify-content-center align-items-center" style="column-gap: 25px; background: #F3F4F5; border-radius: 26px; padding: 25px;">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            <ul class="" style="font-weight: bold;list-style-type: none;background: #DDDDDD;border-radius: 20px; padding: 15px;">
    ...
    <div class="d-flex justify-content-center align-items-center" style="column-gap: 25px; background: #F3F4F5; border-radius: 26px; padding: 25px;">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            <ul style="font-weight: bold;list-style-type: none;background: #DDDDDD;border-radius: 20px; padding: 15px;">
                <li> Vaccination :
